        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_STOP:
				...
				case 0:
					...
					break;
				case 1:
					tv.setText("¹§Ï²,"+string1+"Í¬Ñ§£¬Çë³Ô·¹¿©£¡");
					break;
				case 2:
					tv.setText("¹§Ï²,"+string2+"Í¬Ñ§£¬Çë³Ô·¹¿©£¡");
					break;
				case 3:
					tv.setText("¹§Ï²,"+string3+"Í¬Ñ§£¬Çë³Ô·¹¿©£¡");
					break;
				case 4:
					tv.setText("¹§Ï²,"+string4+"Í¬Ñ§£¬Çë³Ô·¹¿©£¡");
					break;
				case 5:
					tv.setText("¹§Ï²,"+string5+"Í¬Ñ§£¬Çë³Ô·¹¿©£¡");
					break;
				case 6:
					tv.setText("¹§Ï²,"+string6+"Í¬Ñ§£¬Çë³Ô·¹¿©£¡");
					break;
				case 7:
					tv.setText("¹§Ï²,"+string7+"Í¬Ñ§£¬Çë³Ô·¹¿©£¡");
					break;
